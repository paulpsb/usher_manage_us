...
@AllArgsConstructor
@NoArgsConstructor
public class InternalExamsDuolingoSentenceDto{
	private int id;
	...
	private String sentence_doc;
	private int sentence_sort;
	...
	public String getSentence_doc() {
		return sentence_doc;
	}

	public void setSentence_doc(String sentence_doc) {
		this.sentence_doc = sentence_doc;
	}

	public int getSentence_sort() {
		return sentence_sort;
	}

	public void setSentence_sort(int sentence_sort) {
		this.sentence_sort = sentence_sort;
	}
