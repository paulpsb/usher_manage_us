...
@AllArgsConstructor
@NoArgsConstructor
public class InternalExamsDuolingoDescribeDto{
	private int id;
	...
	public int getDescribe_sort() {
		return describe_sort;
	}

	public void setDescribe_sort(int describe_sort) {
		this.describe_sort = describe_sort;
	}
