...
@AllArgsConstructor
@NoArgsConstructor
public class NoticesRoutineTransCoursegroupDetailDto{
	private int id;
	private int routine_day;
	private String routine_date;
	private String routine_start_time;
	private int routine_trans_coursegroup_id;
	...
	public int getRoutine_trans_coursegroup_id() {
		return routine_trans_coursegroup_id;
	}
	public void setRoutine_trans_coursegroup_id(int routine_trans_coursegroup_id) {
		this.routine_trans_coursegroup_id = routine_trans_coursegroup_id;
	}
