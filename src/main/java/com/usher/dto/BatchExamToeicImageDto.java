...
@AllArgsConstructor
@NoArgsConstructor
public class BatchExamToeicImageDto{
	private int id;
	...
	public int getImage_sorting() {
		return image_sorting;
	}
	public void setImage_sorting(int image_sorting) {
		this.image_sorting = image_sorting;
	}
