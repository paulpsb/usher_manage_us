						...
						<table class="table table-striped m-b-0">
							...
							<thead>
								<tr>
									...
									<th class='text-center'>학교명(한글)</th>
									<th class='text-center'>학교명(영문)</th>
...
<!-- end #content -->
<script type="text/javascript" src="/ui/base/school.js"></script>
