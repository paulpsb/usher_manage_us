...
<div class="modal fade" id="modal-memorization">
						...
						<tbody id="data_list">	
							<tr>
								...
								<td class="text-with-form-control">
									<input type="hidden" name="memorization_id" id="memorization_id">
							...
							<tr>
								...
								<td class="text-with-form-control">
									<select class="form-control" name="practice_type" id="practice_type">
									</select> 
								</td>
							</tr>			
							<tr>
...
<!-- end #content -->
<script type="text/javascript" src="/ui/exam/memorization_list.js"></script>
