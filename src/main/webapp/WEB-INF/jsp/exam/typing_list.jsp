...
<div id="content" class="content">
	<!-- begin page-header -->
	<h1 class="page-header">타이핑 시험문제 관리</h1>
	<hr />
	<!-- end page-header -->
		...
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">타이핑 시험문제 목록</h4>
				</div>
...
<div class="modal fade" id="modal-typing">
	<div class="modal-dialog modal-lg" >
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">타이핑 수정</h4>
						...
						<tbody id="data_list">	
							<tr>
								...
								<td class="text-with-form-control" colspan="2">
									<input type="hidden" name="typing_id" id="typing_id">
...
<div class="modal fade" id="modal-typing-content">
	<div class="modal-dialog modal-lg" >
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="table-responsive">
					<table class="table table-th-valign-middle table-td-valign-middle table-bordered m-b-10">
						...
						<tbody id="data_list">	
							<tr>
								<td class="text-with-form-control">
									<input type="hidden" name="typing_content_id" id="typing_content_id">
...
<!-- end #content -->
<script type="text/javascript" src="/ui/exam/typing_list.js"></script>
