...
<div id="content" class="content">
	<!-- begin page-header -->
	<h1 class="page-header">Listening 시험문제 관리</h1>
	<hr />
	<!-- end page-header -->
	<input type="hidden" name="v_page" id="v_page" value="${listeningInfo.page}">
	<input type="hidden" name="v_book" id="v_book" value="${listeningInfo.book}">
	<input type="hidden" name="v_volume" id="v_volume" value="${listeningInfo.volume}">
			...
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				...
				<div class="panel-body">
					<div class="form-group row m-b-15">
						...
						<label class="col-form-label col-1 text-right">이미지</label>
						<div class="col-1">
							<input type="text" class="form-control m-b-5" id="image" name="image" readonly/>
						</div>						
					</div>					
					<div class="form-group row m-b-15">
						...
						<div class="col-3">
							<input type="text" class="form-control m-b-5" id="short_title" name="short_title" readonly/>
						</div>
						<label class="col-form-label col-1 text-right">타입</label>
						<div class="col-1">
							<input type="text" class="form-control m-b-5" id="type" name="type" readonly/>
						</div>
					</div>					
				</div>
			</div>
						...
						<div class="panel-body">
							<div class="form-group row m-b-15">
								<div class="col-md-12">
									...
									<div class="form-group row m-b-15">
										<div class="col-md-12">
											<textarea class="ckeditor" id="listening_question" name="listening_question" rows="30"></textarea>
										</div>
									</div>		
									<div class="form-group row m-b-15">
	...
	<div class="modal-dialog" >
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Audio 듣기</h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-12" id="div_audio">
					</div>
				</div>				
			</div>
			<div class="modal-footer">
				<a href="javascript:audio_form_close();" class="btn btn-white">Close</a>
			</div>
		</div>
	</div>
</div>
...
<script type="text/javascript" src="/ui/exam/listening_question.js"></script>
