...
<div id="content" class="content">
	<!-- begin page-header -->
	<h1 class="page-header">듀오링고 단어 관리</h1>
	<hr />
	<!-- end page-header -->
		...
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-11">
				<div class="panel-heading">
					<h4 class="panel-title">듀오링고 단어 목록</h4>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-12">
						<textarea id="add_multi_voca" class="form-control" style="height:400px;"></textarea>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="/ui/exam/duolingo_voca_list.js"></script>
