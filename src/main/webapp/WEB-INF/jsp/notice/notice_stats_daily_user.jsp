...
<div id="content" class="content">
	<div class="row" id="search_area">
		<div class="col-8">
			<h1 class="page-header">노티스 일간 현황(직원별)</h1>
		</div>
		...
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">노티스 일간 현황(직원별)</h4>
				</div>
...
<div class="modal fade" id="modal-notice-task">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-purple" onclick="task_save('WORKING')">작업 중</button>
				<button type="button" class="btn btn-info" onclick="task_save('RESPONSE')">작업 완료 전송</button>
				<a href="javascript:;" class="btn btn-white" data-dismiss="modal">Close</a>
			</div>
		</div>
	</div>
...
<!-- end #content -->
<script type="text/javascript" src="/ui/notice/notice_stats_daily_user.js"></script>
