	...
	<div class="row" id="search_area">
		...
		<div class="col-3 text-right">
			<h4>
				...
				<button type="button" class="btn btn-white" onclick="go_monthly();">Monthly로 돌아가기</button>
			</h4>
		</div>
		<div class="col-1">
...
<!-- end #content -->
<script type="text/javascript" src="/ui/notice/routine_oraganization_monthly_day.js"></script>
