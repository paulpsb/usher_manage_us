...
<input type="hidden" id="notice_attend_id" value="${teacherInfo.notice_attend_id}">
<!-- begin #content -->
		...
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title" id="practice_title">출결 작성</h4>
				</div>
								...
								<table class="table table-bordered m-b-0">
									...
									<thead>
										<tr>
											...
											<th class="text-center table-info" rowspan="2">이름</th>
											<th class="text-center table-info" rowspan="2">출결상태</th>
...
<script type="text/javascript" src="/ui/mobile/main/dashboard_teacher_attend.js"></script>
