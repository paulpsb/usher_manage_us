...
<div id="content" class="content">
	<div class="row">
		<div class="col-3">
			<h1 class="page-header" id="select_course_title">Syllabus</h1>
		</div>
			...
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">
						Syllabus&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<button type="button" class="btn_select btn btn-primary btn-sm">Syllabus</button>&nbsp;&nbsp;
						<button type="button" class="btn_select btn btn-default btn-sm" onClick="go_homework()">&nbsp;&nbsp;&nbsp;&nbsp;과제&nbsp;&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;
						<button type="button" class="btn_select btn btn-default btn-sm" onClick="go_homework_detail()">과제(개인별)</button>
					</h4>
...
<script type="text/javascript" src="/ui/course/course_schedule.js"></script>
