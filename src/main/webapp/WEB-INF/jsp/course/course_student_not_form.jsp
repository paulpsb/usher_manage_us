...
<div id="content" class="content">
	<!-- begin page-header -->
	<h1 class="page-header">개강인원파악 비 매칭 상세현황</h1>
	<hr />
	<!-- end page-header -->
	
	<input type="hidden" id="user_multi_id" value="${batchInfo.user_multi_id}">
...
<!-- end #content -->
<script type="text/javascript" src="/ui/course/course_student_not_form.js"></script>
