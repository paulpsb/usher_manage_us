...
<div id="content" class="content">
	<div class="row">
		<div class="col-3">
			<h1 class="page-header" id="select_course_title">과제</h1>
		</div>
			...
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">
						...
						<button type="button" class="btn_select btn btn-primary btn-sm">&nbsp;&nbsp;&nbsp;&nbsp;과제&nbsp;&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;
...
<script type="text/javascript" src="/ui/course/course_schedule_homework.js"></script>
