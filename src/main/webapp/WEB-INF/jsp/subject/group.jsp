					...
					<table class="table table-bordered m-b-10">
						...
						<tbody>				
							...
							<tr>
								...
								<td class="text-with-form-control">
									<select class="form-control" id="practice_volume_id" name="practice_volume_id">
									</select>
								</td>
								<td colspan="2">&nbsp;</td>
							</tr>
...
<!-- end #content -->
<!-- end #content -->
<script type="text/javascript" src="/ui/subject/group.js"></script>
