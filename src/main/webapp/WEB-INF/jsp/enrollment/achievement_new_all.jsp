		...
		<div class="col-xl-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">한판보기/성취표 전송</h4>
				</div>
					...
					<div class="row mb-3">
						...
						<div class="col-2">
							...
							<div class="input-group date" id="datepicker-disabled-past" data-date-format="yyyy-dd-mm" data-date-end-date="Date.default">
								...
								<button type="button" class="btn btn-default" onClick="select_date();"><i class="fa fa-calendar"></i></button>
							</div>
						</div>
					</div>				
...
<!-- end #content -->
<div class="modal fade" id="modal-select-date" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" id="div_modal_select_date">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<div class="form-group row m-b-15" id="div_select_calendar">
				</div>	
			</div>
		</div>
	</div>
...
<script type="text/javascript" src="/ui/enrollment/achievement_new_all.js"></script>
