...
<input type="hidden" id="orientation_gubun" value="${archieveInfo.orientation_gubun}">
<!-- begin #content -->
					...
					<div class="form-group">
						<div class="col-12">
							<div class="form-check form-check-inline">
								<input name="check_show" type="radio" id="check_all" class="form-check-input" value="all">
							...
							<div class="form-check form-check-inline">
								<input name="check_show" type="radio" id="check_voca_interval" class="form-check-input" value="voca_interval">
								<label class="form-check-label" for="check_voca_interval">단어 인터벌</label>
							</div>
						</div>
					</div>				
...
<!-- end #content -->
<script type="text/javascript" src="/ui/enrollment/achievement_new_voca.js"></script>
