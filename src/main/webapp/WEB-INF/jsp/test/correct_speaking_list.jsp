...
<div id="content" class="content">
	...
	<div id="search_area" class="row mb-3">
		...
		<div class="col-1">
			<select class="form-control" id="answer_spk_yn">
				<option value="">음성첨삭여부</option>
						...
						<table class="table table-striped m-b-0">
							...
							<thead>
								<tr>
									...
									<th class='text-center'>루브릭채점</th>
									<th class='text-center'>음성첨삭</th>
...
<script type="text/javascript" src="/ui/test/correct_speaking_list.js"></script>