...
<div id="content" class="content">
	<!-- begin page-header -->
	<h1 class="page-header">모의 시험 Direction 관리</h1>
	<hr />
	<!-- end page-header -->
		...
		<div class="col-md-6">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">모의 시험 Direction</h4>
				</div>
				<div class="panel-body">
					...
					<div class="form-group row m-b-15">
						<div class="col-md-12">
							<textarea class="ckeditor" id="mock_test_direction" name="mock_test_direction" rows="30"></textarea>
						</div>
					</div>					
				</div>
			</div>
		...
		<div class="col-md-6">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				...
				<div class="panel-body">
					...
					<div class="form-group row m-b-15">
						<div class="col-md-12">
							<textarea class="ckeditor" id="mock_test_usher_direction" name="mock_test_usher_direction" rows="30"></textarea>
						</div>
					</div>					
				</div>
			</div>
...
<script type="text/javascript" src="/ui/test/mock_test_direction.js"></script>
