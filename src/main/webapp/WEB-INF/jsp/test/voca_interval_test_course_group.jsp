...
<div id="content" class="content">
	<div class="row">
		<div class="col-3">
			<h1 class="page-header">단어 인터벌 트레이닝(반 그룹별)</h1>
		</div>
		...
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">단어 인터벌 트레이닝 정보(반 그룹별)&nbsp;&nbsp;<span id="schedule_info"></span></h4>
				</div>
	...
	<div class="row">
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">단어 인터벌 트레이닝 정보(반 그룹별)</h4>
				</div>
				<div class="panel-body">
					<div class="row mb-3">
						<div class="col-12">
...
<script type="text/javascript" src="/ui/test/voca_interval_test_course_group.js"></script>
