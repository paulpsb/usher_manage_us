...
<html lang="ko">
	<head>
	    ...
	    <script type="text/javascript" src="/ui/test/correct/correct_writing.js"></script>
	</head>
	<body class="toefl">
						...
						<nav role="navigation" aria-label="Top Level Lavigation">
							<ul class="nav">
								<li class="nav-item">
									...
									<button class="btn btn-primary" id="btn_continue" onclick="click_comment_twe()">첨삭 등록/수정</button>
		...
		<div class="container-fluid" id="div_container" style="overflow-y:auto;">
			<div class="container">
				<div class="container" style="width:1019px;padding:0px;background:#e7e2e2;color:#000000">
					<p style="margin:0;padding:0;width:100%;padding:10px;background:#a52626;color:#ffffff;" id="writing_question"><b>Question : </b>${answerInfo.answer}</p>
