...
<div class="bg-white">
	<div class="row bg-purple p-t-20 p-l-20">
		...
		<div class="col-2">
			<button type="button" class="subject passage btn btn-grey btn-lg btn-block" onClick="change_subject('passage')">음원</button>
		</div>
		<div class="col-2">
			<button type="button" class="subject dictation btn btn-grey btn-lg btn-block" onClick="change_subject('dictation')">딕테이션</button>
		</div>
		<div class="col-2">
			<button type="button" class="subject exam btn btn-grey btn-lg btn-block" onClick="change_subject('exam')">음원+시험지</button>
		</div>
	</div>
	<div class="row">
		<div class="col-12 text-center mt-1 mb-1" id="listening_button" style="display:none;">
			<button class="btn btn-info" id="btn_exam_sound" onclick="click_exam_sound()">문제듣기</button>
			<button class="btn btn-info" id="btn_repeat_sound" onclick="click_repeat_sound()">재청취 듣기</button>
			<button class="btn btn-primary" id="btn_prev" onclick="click_exam_prev()">Prev</button>&nbsp;&nbsp;
			<span id="listening_review_question" style="font-weight:bold; font-size:1.15em;padding:10px 0;"></span>&nbsp;&nbsp;
	...
	<div class="row">
		<div class="col-12" id="listening_content">
...
<script type="text/javascript" src="/ui/test/class/listening_class.js"></script>