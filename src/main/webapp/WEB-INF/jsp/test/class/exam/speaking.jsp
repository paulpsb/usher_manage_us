...
<html lang="ko">
	<head>
	    ...
	    <script type="text/javascript" src="/ui/test/class/exam/speaking.js"></script>
	</head>
	<body class="toefl">
		<input type="hidden" id="practice_problem_id" value="${speakingExamInfo.id}">
				...
				<header>
					<div class="navbar navbar-ipt navbar-default">
						...
						<p id="toplabel" style="font-size:14px; user-select:none; -ms-user-select:none; -moz-user-select:none; color:rgb(0,0,0);text-align:center; position:relative; left:-20px; top:14px; width:281px; height:18px; line-height:1.5; z-index:1">
							<b><span id="speaking_label"></span></b>
						</p>
						<nav role="navigation" aria-label="Top Level Lavigation">
							<ul class="nav">
								<li class="nav-item">
									...
									<button class="btn btn-primary" id="btn_exam_task2_step1" onclick="exam_task2_step1()" style="display:none;">Next</button>
								</li>
							</ul>
						</nav>
					</div>
		...
		<div class="container-fluid toolbar">
			<div class="container">
				<div class="row container-ipt" id="secondlevelnav" role="navigation" aria-label="Second Level Navigation">
					<div>
						<button class="btn btn-primary" id="btn_skip_direction" onclick="click_skip_direction()" style="display:none;">Skip Directions</button>
						<button class="btn btn-primary" id="btn_skip_passage2" onclick="click_skip_passage2()" style="display:none;">Skip Passage</button>
						<button class="btn btn-primary" id="btn_skip_passage3" onclick="click_skip_passage3()" style="display:none;">Skip Passage</button>
					</div>
				</div>
			</div>
		</div>
		<div class="container-fluid">
			...
			<div id="content" class="container" style="width:1019px;height:678px;border:1px solid #000;padding:100px;">
