...
<div class="bg-white">
	<div class="row bg-success p-t-20 p-l-20">
		<div class="col-2">
			<h4>RC 수업</h4>
		</div>
	...
	<div class="row">
		<div class="col-12 text-center mt-1 mb-1" id="reading_button" style="display:none;">
			<button class="btn btn-primary" id="btn_prev" onclick="click_exam_prev()">Prev</button>&nbsp;&nbsp;
			<span id="reading_review_question" style="font-weight:bold; font-size:1.15em;padding:10px 0;"></span>&nbsp;&nbsp;
	...
	<div class="row">
		<div class="col-12" id="reading_content">
...
<script type="text/javascript" src="/ui/test/class/reading_class.js"></script>