...
<head>
	...
	<script type="text/javascript" src="/ui/correction/correct/correct_speaking_comment.js"></script>
<body>
	...
	<div id="wrap1">
		...
		<div align="center">
			...
			<textarea cols="100" id="speaking_editor1" name="speaking_editor1" rows="35" style="width:100%;height:550px;">${commentInfo.comment}</textarea>
		</div>
