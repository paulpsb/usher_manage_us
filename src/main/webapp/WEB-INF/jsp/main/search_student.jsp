...
<div id="content" class="content">
	...
	<div id="search_area" class="row mb-3">
		<div class="offset-9 col-2">
			<input type="text" class="form-control" id="search_student_name" value="${searchInfo.student_name}">
		</div>
		<div class="col-1">
		...
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">학생 검색 목록</h4>
				</div>
				<div class="panel-body">
					<div class="table-responsive text-center">
						<table id="tbl_result" class="table table-bordered m-b-0" style="width:1570px;margin-left:auto;margin-right:auto;">
							<thead style="float:left; width:1570px;">
								<tr>
									<th class="text-center table-info" style="width:50px;">No.</th>
									<th class="text-center table-info" style="width:100px;">이름</th>
									<th class="text-center table-info" style="width:150px;">ID</th>
									<th class="text-center table-info" style="width:250px;">전화번호</th>
									<th class="text-center table-info" style="width:100px;">수강월</th>
									<th class="text-center table-info" style="width:200px;">반</th>
									<th class="text-center table-info" colspan="2" style="width:250px;">성취표</th>
									<th class="text-center table-info" style="width:200px;">학교</th>
									<th class="text-center table-info" style="width:150px;">배치고사/상담카드</th>
									<th class="text-center table-info" style="width:120px;">수강후기</th>
								</tr>
							</thead>
							<tbody id="student_list" style="overflow-y:scroll; overflow-x:hidden; float:left; width:1570px; height:400px">
		...
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				...
				<div class="panel-body">
						...
						<table class="table table-bordered m-b-0">
							...
							<thead>
								<tr>
									...
									<th class="text-center table-info" rowspan="2">상담자</th>
					...
					<div class="table-responsive" id="table_data_list" style="height:200px;overflow-y:auto;">
						<table class="table table-bordered m-b-0">
							<colgroup>
								<col style="width:4%;" />
								<col style="width:4%;" />
...
<!-- end #content -->
<script type="text/javascript" src="/ui/main/search_student.js"></script>
