...
<div id="content" class="content">
	<!-- begin page-header -->
	<h1 class="page-header">신규 상담 상세현황</h1>
	<hr />
	<!-- end page-header -->
	
	<input type="hidden" id="semester_date" value="${statsInfo.semester_date}">
	<input type="hidden" id="batch_finally_student_type" value="${statsInfo.batch_finally_student_type}">
	<input type="hidden" id="semester_registration_date" value="${statsInfo.semester_registration_date}">
	
	<input type="hidden" id="finally_register" value="${statsInfo.finally_register}">
	<input type="hidden" id="finally_register_detail" value="${statsInfo.finally_register_detail}">

	<div class="row">
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">신규 상담 상세현황</h4>
				</div>
				<div class="panel-body">
					<div class="table-responsive text-center">
						<table id="example"  class="table table-bordered table-td-valign-middle m-b-0">
							<thead>
								<tr>
									<th class="text-center bg-info" style="width:40px;">No.</th>
									<th class="text-center bg-info" style="width:120px;">이름/상담카드</th>
									<th class="text-center bg-info" style="width:100px;">상담예약일</th>
									<th class="text-center bg-info" style="width:100px;">상담변경일</th>
									<th class="text-center bg-info" style="width:100px;">상담일</th>
									<th class="text-center bg-info" style="width:80px;">상담자</th>
									<th class="text-center bg-info" style="width:120px;">배치 반그룹</th>
									<th class="text-center bg-info" style="width:100px;">배치 반</th>
									<th class="text-center bg-info" style="width:250px;">상담특이사항</th>
									<th class="text-center bg-info" style="width:100px;">시작일</th>
									<th class="text-center bg-info" style="width:100px;">상담 당일 결과</th>
									<th class="text-center bg-info" style="width:200px;">학생 사유</th>
									<th class="text-center bg-info" style="width:100px;">등록일<br>등록예정일<br>고민기한</th>
									<th class="text-center bg-info" style="width:100px;">연락</th>
									<th class="text-center bg-info" style="width:100px;">실제등록여부</th>
									<th class="text-center bg-info" style="width:200px;">사유</th>
								</tr>
							</thead>
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-bordered m-b-0">
							...
							<thead>
								<tr>
									<th class="text-center table-info" rowspan="2">일자</th>
									...
									<th class="text-center table-warning" colspan="3">상담자</th>
									<th class="text-center table-active">데스크</th>
								</tr>							
								<tr>
									<th class="text-center table-info">이름</th>
									<th class="text-center table-info">성별</th>
									<th class="text-center table-info">목표<br>점수</th>
									<th class="text-center table-info">희망<br>수강</th>
									<th class="text-center table-info">학원수강<br>기간</th>
									<th class="text-center table-info">지각<br>여부</th>
									<th class="text-center table-info">집중<br>여부</th>
									<th class="text-center table-info">재시험<br>희망</th>
									<th class="text-center table-info">보유 점수</th>
									<th class="text-center table-info">배치고사<br>점수</th>
									<th class="text-center table-info">보유점수기준<br>적합 반</th>
									<th class="text-center table-info">배치점수기준<br>적합 반</th>
									<th class="text-center table-info">학생<br>의사</th>
									<th class="text-center table-info">학생<br>상중하</th>
									<th class="text-center table-info">수기확인<br>여부</th>
									<th class="text-center table-warning">학생등록의사</th>
									<th class="text-center table-warning">상담카드<br>/반 변경</th>
									<th class="text-center table-warning">상담결과</th>
									<th class="text-center table-active">등록결과</th>
								</tr>
							</thead>
						</table>
					</div>
					<div class="table-responsive" id="table_data_list">
						<table class="table table-bordered m-b-0">
							<colgroup>
								<col style="width:4%;" />
								<col style="width:4%;" />
	...
	<div class="modal-dialog" style="max-width:1200px;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="btn btn-default" onclick="go_modify()" style="position:absolute;width:120px;margin-left:640px;"><i class="fa fa-share fa-fw"></i> 개인정보 수정</button>
				<button type="button" class="btn btn-default" onclick="go_modify_score()" style="position:absolute;width:120px;margin-left:765px;"><i class="fa fa-share fa-fw"></i> 개인성적 수정</button>
				<button type="button" class="btn btn-default" onclick="go_next()" style="position:relative;width:150px;float:right;margin-right:100px;"><i class="fa fa-arrow-right fa-fw"></i></button>
...
<!-- end #content -->
<script type="text/javascript" src="/ui/batch/consultation_stats_form.js"></script>
