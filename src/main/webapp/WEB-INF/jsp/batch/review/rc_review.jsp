	...
	<div id="header">
    	<div id="head1">
            ...
            <ul id="head_btn" class="head_btn right">
            	<li id="viewBtn"><img src="/assets/batch/img/view_text_no.png" /></li>
                <li id="helpBtn"><img src="/assets/batch/img/tpo_help.png" /></li>
                <li id="reviewBtn"><img src="/assets/batch/img/tpo_review_no.png" /></li>
                <li id="prevBtn"><img src="/assets/batch/img/tpo_back_no.png" /></li>
                <li id="nextBtn"><img src="/assets/batch/img/tpo_next.png" /></li>
            </ul>
        </div>
        ...
        <div id="head2">
        	<div class="qnum"><span id="qtxt">Question</span> <span id="qnum">2</span> of <span id="totalCount">42</span></div>
...
<div id="view"></div>
<script type="text/javascript" src="/ui/batch/review/rc_review.js"></script>
</body>
</html>