							...
							<thead>
								...
								<tr>
									...
									<th class="batch_sort text-center table-warning">
										학생<br>등록의사
										<input type="hidden" name="sort_id" value="a.batch_user_register_yn">
										<input type="hidden" name="sort_asc" value="">
										<div class="show_new_student" style="float:right"></div>
									</th>
									...
									<th class="batch_sort text-center table-active">
										최종
										<input type="hidden" name="sort_id" value="(case when e.user_id is null then 'N' else 'Y' end)">
										<input type="hidden" name="sort_asc" value="">
										<div class="show_new_student" style="float:right"></div>
									</th>
									 -->
			...
			<div class="modal-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered m-b-10">
						...
						<tr>
							<th class="text-center table-info" rowspan="7">등록여부<br>(상담자 확인)</th>
							<th>학생 최초 의사</th>
						...
						<tr>
							...
							<td>
								<div class="radio radio-css radio-inline">
									<input type="radio" name="batch_adviser_chamgang_yn" id="batch_adviser_chamgang_yn_Y" value="Y">
									<label for="batch_adviser_chamgang_yn_Y">참강</label>
								</div>
								<div class="radio radio-css radio-inline">
									<input type="radio" name="batch_adviser_chamgang_yn" id="batch_adviser_chamgang_yn_N" value="N">
									<label for="batch_adviser_chamgang_yn_N">현강</label>
								</div>							
							</td>
						</tr>
						<tr>
			...
			<div class="modal-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered m-b-10">
						...
						<tr>
							<th class="text-center table-info" rowspan="8">등록여부<br>(데스크 확인)</th>
							<th>학생 최초 의사</th>
						...
						<tr>
							...
							<td>
								<div class="radio radio-css radio-inline">
									<input type="radio" name="batch_desk_chamgang_yn" id="batch_desk_chamgang_yn_Y" value="Y">
									<label for="batch_desk_chamgang_yn_Y">참강</label>
								</div>
								<div class="radio radio-css radio-inline">
									<input type="radio" name="batch_desk_chamgang_yn" id="batch_desk_chamgang_yn_N" value="N">
									<label for="batch_desk_chamgang_yn_N">현강</label>
								</div>							
							</td>
						</tr>
						<tr>
...
<!-- end #content -->
<script type="text/javascript" src="/ui/batch/consultation.js"></script>
