...
<div id="content" class="content">
	<!-- begin page-header -->
	<h1 class="page-header">신규 상담 현황(상세)</h1>
	<hr />
	<!-- end page-header -->
	<input type="hidden" id="search_batch_schedule_id" value="${statsInfo.batch_schedule_id}">
	<input type="hidden" id="search_batch_adviser_register_yn" value="${statsInfo.batch_adviser_register_yn}">
	<input type="hidden" id="search_batch_adviser_register_date" value="${statsInfo.batch_adviser_register_date}">
	<div id="search_area">
		...
		<div class="col-12">
			<div class="panel panel-inverse" data-sortable-id="table-basic-1">
				<div class="panel-heading">
					<h4 class="panel-title">신규 상담 현황(상세)</h4>
				</div>
				<div class="panel-body" id="div_detail">
				</div>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="modal-finally-not-register-desc">
	<div class="modal-dialog" >
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">최종 사유</h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-12">
						<textarea class="form-control" rows="3" id="batch_finally_not_register_desc"></textarea>
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<a href="javascript:;" class="btn btn-white" data-dismiss="modal">Close</a>
				<a href="javascript:save_finally_not_register_desc();" class="btn btn-success">저장</a>
			</div>
		</div>
	</div>
</div>
<div class="modal fade" id="modal-send-kakao">
	<div class="modal-dialog" >
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">알림톡 전송</h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-12">
						<textarea class="form-control" rows="15" id="send_kakao_desc" readonly></textarea>
					</div>
					<div class="col-12 text-right">
						<p id="send_kakao_sender"></p>
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<a href="javascript:;" class="btn btn-white" data-dismiss="modal">Close</a>
				<a id="btn_send_kakao" href="javascript:save_send_kakao();" class="btn btn-success">보내기</a>
			</div>
		</div>
	</div>
</div>
<div class="modal fade" id="modal-send-mobile">
	<div class="modal-dialog" >
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">전화통화</h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			</div>
			<div class="modal-body">
				<div class="row" id="div_send_mobile">
				</div>
				<div class="row">
					<div class="col-12">
						<textarea class="form-control" rows="15" id="send_phone_desc"></textarea>
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<a href="javascript:;" class="btn btn-white" data-dismiss="modal">Close</a>
				<a href="javascript:save_send_mobile();" class="btn btn-success">저장</a>
			</div>
		</div>
	</div>
</div>
...
<!-- end #content -->
<script type="text/javascript" src="/ui/batch/consultation_schedule_detail.js"></script>