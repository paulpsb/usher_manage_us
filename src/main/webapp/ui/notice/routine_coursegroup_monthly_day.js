...
jQuery(document).ready(function(){
	...
	course_group_name += " "+routine_schedule+"일";
	course_group_name += "("+routine_day+"일차)";
...
function go_monthly()
{
	location.href="/notice/routine_coursegroup_monthly.do?test_type="+test_type+"&&student_type="+student_type+"&&lecture_type="+lecture_type+"&&routine_schedule="+routine_schedule;
}
