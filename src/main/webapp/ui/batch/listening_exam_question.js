...
function search_listening()
{
	$.ajax({
		type : "POST",
		url : "/batch/getBatchExamListeningQuestionList.do",
		data:{
			type:$('#type').val(),
			num:$('#num').val(),
			sub_num:$('#sub_num').val(),
...
function delete_form(question_num){
	...
	$.ajax({
		type : "POST",
		url : "/batch/deleteBatchExamListeningQuestion.do",
		data:{
			type:$('#type').val(),
			num:$('#num').val(),
			sub_num:$('#sub_num').val(),
...
function search_question(question_num)
{
	$.ajax({
		type : "POST",
		url : "/batch/getBatchExamListeningQuestion.do",
		data:{
			type:$('#type').val(),
			num:$('#num').val(),
			sub_num:$('#sub_num').val(),
		...
		success:function(data){
			...
			CKEDITOR.instances.batch_listening_question.setData(cfmNvl1(data.question));
...
function add_question()
{
	$.ajax({
		type : "POST",
		url : "/batch/insertBatchExamListeningQuestion.do",
		data:{
			type:$('#type').val(),
			num:$('#num').val(),
			sub_num:$('#sub_num').val(),
...
function save_question()
{
	...
	var question = CKEDITOR.instances.batch_listening_question.getData();
	...
	$.ajax({
		type : "POST",
		url : "/batch/updateExamListeningQuestion.do",
		data:{
			type:$('#type').val(),
			num:$('#num').val(),
			sub_num:$('#sub_num').val(),
...
function move_form()
{
	location.href = "/batch/listening_exam.do";
}