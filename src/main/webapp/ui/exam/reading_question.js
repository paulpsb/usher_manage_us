...
function resizeContents()
{
	...
	$("#passage_list").height(window_size-250);

}

function move_form()
{
	location.href = "/exam/reading_form.do?id="+$("#reading_id").val()+"&&page="+$("#v_page").val()+"&&book="+$("#v_book").val()+"&&volume="+$("#v_volume").val();
}
...
function search_reading()
{
	$.ajax({
		type : "POST",
		url : "/exam/getExamReadingQuestionList.do",
		data:{
			id:$("#reading_id").val()
		},
		success:function(data){
			...
			$("#book").val(readingInfo.book);
			$("#volume").val(readingInfo.volume);
			$("#group").val(readingInfo.group);
			$("#article").val(readingInfo.article);
...
function add_question()
{
	$.ajax({
		type : "POST",
		url : "/exam/insertExamReadingQuestion.do",
		data:{
			reading_id:$("#reading_id").val()
		},
		success:function(data){
			search_reading();
			//alert(data.id);
...
function delete_form(question_num)
{
	...
	$.ajax({
		type : "POST",
		url : "/exam/deleteExamReadingQuestion.do",
		data:{
			reading_id:$("#reading_id").val(),
...
function clear_question()
{
	...
	$("#txt_passage").html("");
	$("#passage").val("");
	CKEDITOR.instances.internal_reading_question_paragraph1.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph2.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph3.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph4.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph5.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph6.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph7.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph8.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph9.setData("");
	CKEDITOR.instances.internal_reading_question_paragraph10.setData("");
	
	CKEDITOR.instances.internal_reading_question.setData("");
	create_question();
}
...
function modify_form(question_num)
{
	...
	$.ajax({
		type : "POST",
		url : "/exam/getExamReadingQuestion.do",
		data:{
			reading_id:$("#reading_id").val(),
			question_num:question_num
		},
		success:function(data){
			...
			if(data.question_type){
				...
				CKEDITOR.instances.internal_reading_question_paragraph1.setData(data.paragraph1);
				CKEDITOR.instances.internal_reading_question_paragraph2.setData(data.paragraph2);
				CKEDITOR.instances.internal_reading_question_paragraph3.setData(data.paragraph3);
				CKEDITOR.instances.internal_reading_question_paragraph4.setData(data.paragraph4);
				CKEDITOR.instances.internal_reading_question_paragraph5.setData(data.paragraph5);
				CKEDITOR.instances.internal_reading_question_paragraph6.setData(data.paragraph6);
				CKEDITOR.instances.internal_reading_question_paragraph7.setData(data.paragraph7);
				CKEDITOR.instances.internal_reading_question_paragraph8.setData(data.paragraph8);
				CKEDITOR.instances.internal_reading_question_paragraph9.setData(data.paragraph9);
				CKEDITOR.instances.internal_reading_question_paragraph10.setData(data.paragraph10);
				
				CKEDITOR.instances.internal_reading_question.setData(data.question);
			}else{
				$("#question_type").val("VO");
				$("#score").val("1");
				$("#category").val("A");
				
				$("#txt_passage").html(readingInfo.passage);
				$("#passage").val(readingInfo.passage);
				CKEDITOR.instances.internal_reading_question_paragraph1.setData(readingInfo.paragraph1);
				CKEDITOR.instances.internal_reading_question_paragraph2.setData(readingInfo.paragraph2);
				CKEDITOR.instances.internal_reading_question_paragraph3.setData(readingInfo.paragraph3);
				CKEDITOR.instances.internal_reading_question_paragraph4.setData(readingInfo.paragraph4);
				CKEDITOR.instances.internal_reading_question_paragraph5.setData(readingInfo.paragraph5);
				CKEDITOR.instances.internal_reading_question_paragraph6.setData(readingInfo.paragraph6);
				CKEDITOR.instances.internal_reading_question_paragraph7.setData(readingInfo.paragraph7);
				CKEDITOR.instances.internal_reading_question_paragraph8.setData(readingInfo.paragraph8);
				CKEDITOR.instances.internal_reading_question_paragraph9.setData(readingInfo.paragraph9);
				CKEDITOR.instances.internal_reading_question_paragraph10.setData(readingInfo.paragraph10);
...
function form_submit()
{
	...
	var question = CKEDITOR.instances.internal_reading_question.getData();
	...
	var paragraph1 = CKEDITOR.instances.internal_reading_question_paragraph1.getData();
	var paragraph2 = CKEDITOR.instances.internal_reading_question_paragraph2.getData();
	var paragraph3 = CKEDITOR.instances.internal_reading_question_paragraph3.getData();
	var paragraph4 = CKEDITOR.instances.internal_reading_question_paragraph4.getData();
	var paragraph5 = CKEDITOR.instances.internal_reading_question_paragraph5.getData();
	var paragraph6 = CKEDITOR.instances.internal_reading_question_paragraph6.getData();
	var paragraph7 = CKEDITOR.instances.internal_reading_question_paragraph7.getData();
	var paragraph8 = CKEDITOR.instances.internal_reading_question_paragraph8.getData();
	var paragraph9 = CKEDITOR.instances.internal_reading_question_paragraph9.getData();
	var paragraph10 = CKEDITOR.instances.internal_reading_question_paragraph10.getData();
	...
	$.ajax({
		type : "POST",
		url : "/exam/updateExamReadingQuestion.do",
		data:{
...
{
	var oEditor = CKEDITOR.instances.internal_reading_question;
	...
	if(!text) 
		...
		value = '<span class="marker1" style="background-color:#ccc">'+text+'</span>';
...
function paragraph_editor(id)
{
	var oid=id;
	//var oEditor = CKEDITOR.instances.oid;
	eval('var oEditor=CKEDITOR.instances.'+oid);
	...
	if(!text) 
		...
		value = '<span class="qmarker" style="background-color:#ccc">'+text+'</span>';
