...
function search_form()
{
	$.ajax({
		...
		success:function(data){	
			file_temp_upload(data.resultInfo.answer);
			//alert(audio_url);
		},
...
function savePen(v_comment)
{
	$.ajax({
		type : "POST",
		url : "/correction/correct/saveSpeakingTestPen.do",
		data:{
			correction_exams_answer_id:$("#correction_exams_answer_id").val(),
			pen_comment:v_comment,
			pen_comment_review:""
		},
		success:function(data){
			alert("저장하였습니다.");
