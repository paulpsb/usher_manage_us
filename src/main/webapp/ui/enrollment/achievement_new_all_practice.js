...
function form_init()
{
	...
	$.ajax({
		type : "POST",
		url : "/enrollment/getAchieveAllPracticeList.do",
		data:{
		...
		success:function(data){
			...
			//상단화면을 그려준다.
			create_top_menu(data.sectionList, data.practiceAllList,  $("#section").val(), "all_practice", $("#course_id").val(), data.courseInfo.student_type);
