...
<body>
 ...
 {
	  audioFile.pause();
	  __log("Start: " + audioFile.buffered.start(0)
			  + " End: " + audioFile.buffered.end(0));
 }
  ...
  function startRecording(button) {
  		audioFile = new Audio("http://127.0.0.1:8090/test.mp3");
		audioFile.onended = function() {
			
		};
		audioFile.oncanplay = function() {
			var stream = audioFile.captureStream();
			__log("stream =>"+stream);
		};
		audioFile.play();
